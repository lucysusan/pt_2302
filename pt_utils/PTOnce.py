...
@author: Susan
# TODO:第一次OPEN都没有仓位; PairOn增加对数; Backtest收益计算
"""
...
# pt_db = PairOn(form_end, form_freq, form_freq_num, out_folder=trade_out_folder + 'formation/')
...
trade = Trading(pair_entry_dict, bar, trans_start, trans_freq, trans_freq_num,
